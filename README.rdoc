...
To use the IzPack plugin, include in your build script:
  ...
  define 'myProject' do
    Buildr::write File.join(_,"src","main","java", "Hello.java"), "public class Hello {}"
    package(:izpack).enhance do |installer|
      installer.addPack('myApp', :files => package(:jar))
    end
  end

TODO: A full, working example
